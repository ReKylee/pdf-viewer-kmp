...
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeInitialize(
    JNIEnv*,
    jobject) {
  pdfv_initialize();
}
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeDestroy(
    JNIEnv*,
    jobject) {
  pdfv_destroy();
}
...
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeOpen(
    JNIEnv* env,
    jobject,
    jbyteArray data,
    jstring password) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeClose(
    JNIEnv*,
    jobject,
    jlong handle) {
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeDocumentInformation(
    JNIEnv* env,
    jobject,
    jlong handle) {
...
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeMetadata(
    JNIEnv* env,
    jobject,
    jlong handle,
    jstring tag) {
...
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativePageInformation(
    JNIEnv* env,
    jobject,
    jlong handle,
    jint page_index) {
...
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeRender(
    JNIEnv* env,
    jobject,
    jlong handle,
    jint page_index,
...
extern "C" JNIEXPORT jstring JNICALL
Java_io_github_limuyang2_pdf_core_internal_AndroidPdfiumNative_nativeExtractText(
    JNIEnv* env,
    jobject,
    jlong handle,
    jint page_index,
